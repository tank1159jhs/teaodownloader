...
const TRANSLATIONS = {
  ...
  ja: {
    ...
    meta_description: "TikTok、Douyin(抖音)、Instagram、YouTube、Xの動画を即座にダウンロード。ウォーターマークなし、完全無料の最強ツール.",
    hero_title: "⚡ TAEO 動画保存・ダウンロード",
    hero_subtitle: "TikTok, Douyin, Insta, YouTube, X 動画を最速保存",
    hero_description: "TikTok、Douyin、Instagram、YouTube、Xの動画をウォーターマークなしで保存する最強の無料ツールです。",
    input_placeholder: "ここにリンク(TikTok, Douyin, Insta, YouTube, X)を貼り付けてください...",
    download_btn: "ダウンロード",
    loading: "動画を分析中...",
    error_occurred: "エラー",
    ...
    save_log: "保存場所の選択ウィンドウが表示されるまで, 최대 20초 정도 소요될 수 있습니다. 表示되는까지 그대로 기다려 주십시오.",
    ...
    faq_a1: "TikTok, Douyin, Instagram, YouTube, X(Twitter)に対応しています. URLを貼るだけでOKです.",
    faq_q2: "利用料金はかかりますか?",
