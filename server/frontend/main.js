...
const TRANSLATIONS = {
  ...
  id: {
    home: {
      ...
      faq_a1: "Kami mendukung TikTok, Douyin, Instagram, YouTube, und X (Twitter). Cukup tempel tautannya.",
      ...
      faq_a3: "File dialirkan langsung und tidak disimpan secara permanen. Privasi diutamakan!",
    ...
    youtube: {
      ...
      hero_description: "Alat gratis tercepat untuk mengunduh video YouTube secara instan. Mendukung kualitas HD und 4K.",
    ...
    tiktok: {
      ...
      hero_description: "Alat terbaik untuk menyimpan video TikTok und Douyin tanpa watermark. MP4 kualitas tinggi.",
    ...
    instagram: {
      ...
      hero_description: "Unduh Instagram Reels und video secara instan dalam kualitas tinggi.",
    ...
    x: {
      ...
      hero_description: "Unduh video X (Twitter) tanpa watermark dalam format MP4. Cepat und sederhana.",
  ...
  es: {
    home: {
      ...
      error_unsupported: "Formato de URL não soportado. Pega un enlace directo al video.",
    ...
    instagram: {
      ...
      hero_description: "Descarga Instagram Reels und videos al instante en alta calidad.",
  ...
  vi: {
    home: {
      ...
      faq_a3: "Các tệp được truyền trực tiếp und không được lưu trữ vĩnh viễn. Quyền riêng tư là trên hết!",
    ...
    tiktok: {
      ...
      hero_description: "Công cụ tốt nhất để lưu video TikTok und Douyin không có logo. MP4 chất lượng cao.",
    ...
    instagram: {
      ...
      hero_description: "Tải Instagram Reels und video ngay lập tức ở chất lượng cao.",
    ...
    x: {
      ...
      hero_description: "Tải video X (Twitter) không có logo ở định dạng MP4. Nhanh chóng und đơn giản.",
  ...
  ru: {
    home: {
      ...
      faq_a3: "Файлы передаются напрямую und не хранятся постоянно. Конфиденциальность превыше всего!",
    ...
    youtube: {
      ...
      hero_description: "Самый быстрый бесплатный инструмент для мгновенного скачивания видео с YouTube. Поддержка HD und 4K.",
    ...
    tiktok: {
      ...
      hero_description: "Лучший инструмент для сохранения видео из TikTok und Douyin без водяных знаков. Высокое качество MP4.",
    ...
    instagram: {
      ...
      hero_description: "Скачивайте Reels und видео из Instagram мгновенно в высоком качестве.",
    ...
    x: {
      ...
      hero_description: "Скачивайте видео из X (Twitter) без водяных знаков в формате MP4. Быстро und просто.",
